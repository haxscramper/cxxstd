...
type
  ...
  # Declaration created in: hc_wrapgen.nim(647, 24)
  ...
  # Declaration created in: hc_wrapgen.nim(792, 20)
...
# Declaration created in: hc_wrapgen.nim(446, 22)
# Wrapper for `std::char_traits`
...
# Declaration created in: hc_wrapgen.nim(460, 22)
# Wrapper for `std::char_traits`
# Declared in bits/stringfwd.h:55
...
# Declaration created in: hc_wrapgen.nim(471, 22)
# Wrapper for `std::char_traits`
# Declared in bits/stringfwd.h:55
...
# Declaration created in: hc_wrapgen.nim(750, 22)
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::npos`
# Declared in bits/basic_string.h:101
proc npos*[CharT; Traits; Alloc](self: StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
...
proc `npos =`*(self: StdBasicString[CharT, Traits, Alloc];
               value: CxxTemplateUndefined) {.error: "Cannot assign to field npos - declared `const` in std::basic_string<_CharT, _Traits, _Alloc>::npos".}
  ## @import{[[code:namespace!std::class!basic_stringvar!npos]]}
...
proc setFrom*(self: var StdBasicString[CharT, Traits, Alloc];
              str: StdBasicString[CharT, Traits, Alloc]): StdBasicString[CharT,
...
proc cxBegin*(self: var StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
...
proc cxBegin*(self: StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.begin(@))", header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.method!begin(): tkTypedef]]}
...
proc cxEnd*(self: var StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.end(@))", header: r"<string>".}
...
proc cxEnd*(self: StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.end(@))", header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.method!end(): tkTypedef]]}
...
proc cbegin*(self: StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
...
proc cend*(self: StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
...
proc size*(self: StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.size(@))", header: r"<string>".}
...
proc length*(self: StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.length(@))", header: r"<string>".}
...
proc maxSize*(self: StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.max_size(@))", header: r"<string>".}
...
proc resize*(self: var StdBasicString[CharT, Traits, Alloc];
             n: CxxTemplateUndefined[CharT, Traits, Alloc]; c: CharT): void {.
...
proc resize*(self: var StdBasicString[CharT, Traits, Alloc];
             n: CxxTemplateUndefined[CharT, Traits, Alloc]): void {.
    importcpp: r"(#.resize(@))", header: r"<string>".}
...
proc capacity*(self: StdBasicString[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.capacity(@))", header: r"<string>".}
...
proc reserve*(self: var StdBasicString[CharT, Traits, Alloc];
              resArg: CxxTemplateUndefined[CharT, Traits, Alloc]): void {.
...
proc `[]`*(self: StdBasicString[CharT, Traits, Alloc];
           pos: CxxTemplateUndefined[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"#[#]", header: r"<string>".}
...
proc at*(self: StdBasicString[CharT, Traits, Alloc];
         n: CxxTemplateUndefined[CharT, Traits, Alloc]): CxxTemplateUndefined {.
...
proc append*(self: var StdBasicString[CharT, Traits, Alloc];
             str: StdBasicString[CharT, Traits, Alloc]): StdBasicString[CharT,
    Traits, Alloc] {.importcpp: r"(#.append(@))", header: r"<string>".}
...
proc append*(self: var StdBasicString[CharT, Traits, Alloc];
             ...
             pos: CxxTemplateUndefined[CharT, Traits, Alloc];
             n: CxxTemplateUndefined[CharT, Traits, Alloc]): StdBasicString[
...
proc append*(self: var StdBasicString[CharT, Traits, Alloc];
             n: CxxTemplateUndefined[CharT, Traits, Alloc]; c: CharT): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"(#.append(@))", header: r"<string>".}
...
proc assign*(self: var StdBasicString[CharT, Traits, Alloc];
             str: StdBasicString[CharT, Traits, Alloc]): StdBasicString[CharT,
    Traits, Alloc] {.importcpp: r"(#.assign(@))", header: r"<string>".}
...
proc insert*(self: var StdBasicString[CharT, Traits, Alloc];
             p: CxxTemplateUndefined[CharT, Traits, Alloc];
             n: CxxTemplateUndefined[CharT, Traits, Alloc]; c: CharT): CxxTemplateUndefined {.
...
proc insert*(self: var StdBasicString[CharT, Traits, Alloc];
             p: CxxTemplateUndefined[CharT, Traits, Alloc];
             l: StdInitializerList): CxxTemplateUndefined {.
    importcpp: r"(#.insert(@))", header: r"<string>".}
...
proc insert*(self: var StdBasicString[CharT, Traits, Alloc];
             pos1: CxxTemplateUndefined[CharT, Traits, Alloc];
             str: StdBasicString[CharT, Traits, Alloc]): StdBasicString[CharT,
    Traits, Alloc] {.importcpp: r"(#.insert(@))", header: r"<string>".}
...
proc insert*(self: var StdBasicString[CharT, Traits, Alloc];
             pos1: CxxTemplateUndefined[CharT, Traits, Alloc];
             str: StdBasicString[CharT, Traits, Alloc];
             pos2: CxxTemplateUndefined[CharT, Traits, Alloc];
             n: CxxTemplateUndefined[CharT, Traits, Alloc]): StdBasicString[
...
proc insert*(self: var StdBasicString[CharT, Traits, Alloc];
             pos: CxxTemplateUndefined[CharT, Traits, Alloc]; s: ptr CharT;
             n: CxxTemplateUndefined[CharT, Traits, Alloc]): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"(#.insert(@))", header: r"<string>".}
...
proc insert*(self: var StdBasicString[CharT, Traits, Alloc];
             pos: CxxTemplateUndefined[CharT, Traits, Alloc]; s: ptr CharT): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"(#.insert(@))", header: r"<string>".}
...
proc insert*(self: var StdBasicString[CharT, Traits, Alloc];
             p: CxxTemplateUndefined[CharT, Traits, Alloc]; c: CharT): CxxTemplateUndefined {.
    importcpp: r"(#.insert(@))", header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.method!insert(tkTypedef, tkUnexposed): tkTypedef]]}
...
proc erase*(self: var StdBasicString[CharT, Traits, Alloc];
            position: CxxTemplateUndefined[CharT, Traits, Alloc]): CxxTemplateUndefined {.
...
proc erase*(self: var StdBasicString[CharT, Traits, Alloc];
            first: CxxTemplateUndefined[CharT, Traits, Alloc];
            last: CxxTemplateUndefined[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.erase(@))", header: r"<string>".}
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              pos: CxxTemplateUndefined[CharT, Traits, Alloc];
              n: CxxTemplateUndefined[CharT, Traits, Alloc];
              str: StdBasicString[CharT, Traits, Alloc]): StdBasicString[CharT,
    Traits, Alloc] {.importcpp: r"(#.replace(@))", header: r"<string>".}
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              pos1: CxxTemplateUndefined[CharT, Traits, Alloc];
              n1: CxxTemplateUndefined[CharT, Traits, Alloc];
              str: StdBasicString[CharT, Traits, Alloc];
              pos2: CxxTemplateUndefined[CharT, Traits, Alloc];
              n2: CxxTemplateUndefined[CharT, Traits, Alloc]): StdBasicString[
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              pos: CxxTemplateUndefined[CharT, Traits, Alloc];
              n1: CxxTemplateUndefined[CharT, Traits, Alloc]; s: ptr CharT;
              n2: CxxTemplateUndefined[CharT, Traits, Alloc]): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"(#.replace(@))", header: r"<string>".}
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              pos: CxxTemplateUndefined[CharT, Traits, Alloc];
              n1: CxxTemplateUndefined[CharT, Traits, Alloc]; s: ptr CharT): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"(#.replace(@))", header: r"<string>".}
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              pos: CxxTemplateUndefined[CharT, Traits, Alloc];
              n1: CxxTemplateUndefined[CharT, Traits, Alloc];
              n2: CxxTemplateUndefined[CharT, Traits, Alloc]; c: CharT): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"(#.replace(@))", header: r"<string>".}
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              i1: CxxTemplateUndefined[CharT, Traits, Alloc];
              i2: CxxTemplateUndefined[CharT, Traits, Alloc];
              str: StdBasicString[CharT, Traits, Alloc]): StdBasicString[CharT,
    Traits, Alloc] {.importcpp: r"(#.replace(@))", header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.method!replace(tkTypedef, tkTypedef, tkLValueReference): tkLValueReference]]}
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              i1: CxxTemplateUndefined[CharT, Traits, Alloc];
              i2: CxxTemplateUndefined[CharT, Traits, Alloc]; s: ptr CharT;
              n: CxxTemplateUndefined[CharT, Traits, Alloc]): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"(#.replace(@))", header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.method!replace(tkTypedef, tkTypedef, ptr[tkUnexposed], tkTypedef): tkLValueReference]]}
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              i1: CxxTemplateUndefined[CharT, Traits, Alloc];
              i2: CxxTemplateUndefined[CharT, Traits, Alloc]; s: ptr CharT): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"(#.replace(@))", header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.method!replace(tkTypedef, tkTypedef, ptr[tkUnexposed]): tkLValueReference]]}
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              i1: CxxTemplateUndefined[CharT, Traits, Alloc];
              i2: CxxTemplateUndefined[CharT, Traits, Alloc]; k1: ptr CharT;
              k2: ptr CharT): StdBasicString[CharT, Traits, Alloc] {.
...
proc replace*(self: var StdBasicString[CharT, Traits, Alloc];
              i1: CxxTemplateUndefined[CharT, Traits, Alloc];
              i2: CxxTemplateUndefined[CharT, Traits, Alloc];
              k1: CxxTemplateUndefined[CharT, Traits, Alloc];
              k2: CxxTemplateUndefined[CharT, Traits, Alloc]): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"(#.replace(@))", header: r"<string>".}
...
proc copy*(self: StdBasicString[CharT, Traits, Alloc]; s: ptr CharT;
           n: CxxTemplateUndefined[CharT, Traits, Alloc];
           pos: CxxTemplateUndefined[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.copy(@))", header: r"<string>".}
...
proc swap*(self: var StdBasicString[CharT, Traits, Alloc];
...
proc find*(self: StdBasicString[CharT, Traits, Alloc];
           str: StdBasicString[CharT, Traits, Alloc];
           pos: CxxTemplateUndefined[CharT, Traits, Alloc]): CxxTemplateUndefined {.
    importcpp: r"(#.find(@))", header: r"<string>".}
...
proc rfind*(self: StdBasicString[CharT, Traits, Alloc];
            str: StdBasicString[CharT, Traits, Alloc];
            pos: CxxTemplateUndefined[CharT, Traits, Alloc]): CxxTemplateUndefined {.
...
proc compare*(self: StdBasicString[CharT, Traits, Alloc];
              ...
              str: StdBasicString[CharT, Traits, Alloc];
              pos2: CxxTemplateUndefined[CharT, Traits, Alloc];
              n2: CxxTemplateUndefined[CharT, Traits, Alloc]): cint {.
    importcpp: r"(#.compare(@))", header: r"<string>".}
...
proc compare*(self: StdBasicString[CharT, Traits, Alloc];
              pos: CxxTemplateUndefined[CharT, Traits, Alloc];
              n1: CxxTemplateUndefined[CharT, Traits, Alloc]; s: ptr CharT): cint {.
    importcpp: r"(#.compare(@))", header: r"<string>".}
...
proc newBasicString*(str: StdBasicString[CharT, Traits, Alloc]): Ref[
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:448
proc cnewBasicString*(str: StdBasicString[CharT, Traits, Alloc]): ptr StdBasicString[
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:448
proc initBasicString*(str: StdBasicString[CharT, Traits, Alloc]): StdBasicString[
...
proc newBasicString*(str: StdBasicString[CharT, Traits, Alloc];
                     pos: CxxTemplateUndefined[CharT, Traits, Alloc]; a: Alloc): Ref[
    StdBasicString[CharT, Traits, Alloc]] {.
    importcpp: r"new std::basic_string<'0, '1, '2>(@)", header: r"<string>".} =
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:461
proc cnewBasicString*(str: StdBasicString[CharT, Traits, Alloc];
                      pos: CxxTemplateUndefined[CharT, Traits, Alloc]; a: Alloc): ptr StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"new std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(tkLValueReference, tkTypedef, tkLValueReference): void]]}
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:461
proc initBasicString*(str: StdBasicString[CharT, Traits, Alloc];
                      pos: CxxTemplateUndefined[CharT, Traits, Alloc]; a: Alloc): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(tkLValueReference, tkTypedef, tkLValueReference): void]]}
...
proc newBasicString*(str: StdBasicString[CharT, Traits, Alloc];
                     pos: CxxTemplateUndefined[CharT, Traits, Alloc];
                     n: CxxTemplateUndefined[CharT, Traits, Alloc]): Ref[
    StdBasicString[CharT, Traits, Alloc]] {.
    importcpp: r"new std::basic_string<'0, '1, '2>(@)", header: r"<string>".} =
...
proc cnewBasicString*(str: StdBasicString[CharT, Traits, Alloc];
                      pos: CxxTemplateUndefined[CharT, Traits, Alloc];
                      n: CxxTemplateUndefined[CharT, Traits, Alloc]): ptr StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"new std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(tkLValueReference, tkTypedef, tkTypedef): void]]}
...
proc newBasicString*(str: StdBasicString[CharT, Traits, Alloc];
                     pos: CxxTemplateUndefined[CharT, Traits, Alloc];
                     n: CxxTemplateUndefined[CharT, Traits, Alloc]; a: Alloc): Ref[
    StdBasicString[CharT, Traits, Alloc]] {.
    importcpp: r"new std::basic_string<'0, '1, '2>(@)", header: r"<string>".} =
...
proc cnewBasicString*(str: StdBasicString[CharT, Traits, Alloc];
                      pos: CxxTemplateUndefined[CharT, Traits, Alloc];
                      n: CxxTemplateUndefined[CharT, Traits, Alloc]; a: Alloc): ptr StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"new std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(tkLValueReference, tkTypedef, tkTypedef, tkLValueReference): void]]}
...
proc initBasicString*(str: StdBasicString[CharT, Traits, Alloc];
                      pos: CxxTemplateUndefined[CharT, Traits, Alloc];
                      n: CxxTemplateUndefined[CharT, Traits, Alloc]; a: Alloc): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(tkLValueReference, tkTypedef, tkTypedef, tkLValueReference): void]]}
...
proc newBasicString*(s: ptr CharT;
                     n: CxxTemplateUndefined[CharT, Traits, Alloc]; a: Alloc): Ref[
    StdBasicString[CharT, Traits, Alloc]] {.
    importcpp: r"new std::basic_string<'0, '1, '2>(@)", header: r"<string>".} =
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:510
proc cnewBasicString*(s: ptr CharT;
                      n: CxxTemplateUndefined[CharT, Traits, Alloc]; a: Alloc): ptr StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"new std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(ptr[tkUnexposed], tkTypedef, tkLValueReference): void]]}
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:510
proc initBasicString*(s: ptr CharT;
                      n: CxxTemplateUndefined[CharT, Traits, Alloc]; a: Alloc): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(ptr[tkUnexposed], tkTypedef, tkLValueReference): void]]}
...
proc newBasicString*(s: ptr CharT; a: Alloc): Ref[
    StdBasicString[CharT, Traits, Alloc]] {.
    importcpp: r"new std::basic_string<'0, '1, '2>(@)", header: r"<string>".} =
...
proc newBasicString*(n: CxxTemplateUndefined[CharT, Traits, Alloc]; c: CharT;
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:540
proc cnewBasicString*(n: CxxTemplateUndefined[CharT, Traits, Alloc]; c: CharT;
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:540
proc initBasicString*(n: CxxTemplateUndefined[CharT, Traits, Alloc]; c: CharT;
...
proc newBasicString*(l: StdInitializerList; a: Alloc): Ref[
    StdBasicString[CharT, Traits, Alloc]] {.
    importcpp: r"new std::basic_string<'0, '1, '2>(@)", header: r"<string>".} =
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:579
proc cnewBasicString*(l: StdInitializerList; a: Alloc): ptr StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"new std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(tkUnexposed, tkLValueReference): void]]}
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:579
proc initBasicString*(l: StdInitializerList; a: Alloc): StdBasicString[CharT,
...
proc newBasicString*(str: StdBasicString[CharT, Traits, Alloc]; a: Alloc): Ref[
    StdBasicString[CharT, Traits, Alloc]] {.
    importcpp: r"new std::basic_string<'0, '1, '2>(@)", header: r"<string>".} =
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:583
proc cnewBasicString*(str: StdBasicString[CharT, Traits, Alloc]; a: Alloc): ptr StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"new std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(tkLValueReference, tkLValueReference): void]]}
...
# Wrapper for `std::basic_string<_CharT, _Traits, _Alloc>::basic_string<_CharT, _Traits, _Alloc>`
# Declared in bits/basic_string.h:583
proc initBasicString*(str: StdBasicString[CharT, Traits, Alloc]; a: Alloc): StdBasicString[
    CharT, Traits, Alloc] {.importcpp: r"std::basic_string<'0, '1, '2>(@)",
                            header: r"<string>".}
  ## @import{[[code:namespace!std::class!basic_string.contructor!basic_string<_CharT, _Traits, _Alloc>(tkLValueReference, tkLValueReference): void]]}
...
proc `>>`*(cxIs: StdBasicIstream; str: StdBasicString[CharT, Traits, Alloc]): StdBasicIstream {.
    importcpp: r"(std::operator>><'0, '1, '2>(#, #))", header: r"<string>".}
...
proc `>>`*(os: StdBasicOstream; str: StdBasicString[CharT, Traits, Alloc]): StdBasicOstream {.
    importcpp: r"(std::operator<<<'0, '1, '2>(#, #))", header: r"<string>".}
  ## @import{[[code:namespace!std::.proc!operator<<(tkLValueReference, tkLValueReference): tkLValueReference]]}
...
proc getline*(cxIs: StdBasicIstream; str: StdBasicString[CharT, Traits, Alloc];
              delim: CharT): StdBasicIstream {.
...
proc getline*(cxIs: StdBasicIstream; str: StdBasicString[CharT, Traits, Alloc]): StdBasicIstream {.
    importcpp: r"(std::getline<'0, '1, '2>(@))", header: r"<string>".}
...
proc getline*(cxIn: StdBasicIstream; str: StdBasicString[CharT, Traits, Alloc];
              delim: cchar): StdBasicIstream {.importcpp: r"(std::getline(@))",
    header: r"<string>".}
...
proc getline*(cxIn: StdBasicIstream; str: StdBasicString[CharT, Traits, Alloc];
              delim: cwchar): StdBasicIstream {.importcpp: r"(std::getline(@))",
    header: r"<string>".}
...
proc toStdBasicString*(str: ptr cwchar; len: StdSizeT): StdBasicString[CharT,
    Traits, Alloc] {.importcpp: r"(operator""""s(@))", header: r"<string>".}
...
proc toStdBasicString*(str: ptr cchar16; len: StdSizeT): StdBasicString[CharT,
    Traits, Alloc] {.importcpp: r"(operator""""s(@))", header: r"<string>".}
...
proc toStdBasicString*(str: ptr cchar32; len: StdSizeT): StdBasicString[CharT,
    Traits, Alloc] {.importcpp: r"(operator""""s(@))", header: r"<string>".}
...
proc `>>`*(cxIn: StdBasicIstream; str: StdBasicString[CharT, Traits, Alloc]): StdBasicIstream {.
    importcpp: r"(std::operator>><'0, '1, '2>(#, #))", header: r"<string>".}
  ## @import{[[code:namespace!std::.proc!operator>>(tkLValueReference, tkLValueReference): tkLValueReference]]}
